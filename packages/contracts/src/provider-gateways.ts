...
export interface AiGenerationRequest {
  task:
    ...
    | "prospecting.icp_copilot"
    | "prospecting.filter_translation"
    | "prospecting.classification"
    | "prospecting.score_explanation"
    | "prospecting.opportunity_brief"
    | "prospecting.outreach_draft"
    | "prospecting.reply_classification"
