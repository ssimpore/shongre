...
export const SHONGRE_PROVIDER_REGISTRY: readonly ProviderOperationalDefinition[] =
  [
    ...
    {
      id: "shongre_analytics",
      displayName: "Shongre Internal Analytics",
      kind: "INTERNAL",
      category: "ANALYTICS",
      capabilities: ["analytics.product", "analytics.authoritative_reporting"],
      implementedCapabilities: [
        "analytics.product",
        "analytics.authoritative_reporting",
      ],
      adapterStatus: "IMPLEMENTED",
      lifecycle: "IMPLEMENTED",
      criticality: "P1",
      runtimeOwner: "backend/src/modules/analytics",
      requiredEnvironmentVariables: ["ANALYTICS_MODE"],
      healthCheckKind: "INTERNAL_PROBE",
      webhookSupport: "NONE",
      supportedMarkets: ["*"],
      supportedCurrencies: ["EUR", "CHF"],
      evidence: [
        "Append-only event ledger, finance-backed aggregates, RLS, retention and privacy anonymization are migration-driven.",
        "Browser capture uses a consent-gated provider-neutral SDK and the backend exposes permission-separated reports.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        ["analytics.product"],
        "P2",
        "frontend/src/analytics/providers/posthog.provider.ts",
        "https://posthog.com/docs",
      ),
      implementedCapabilities: ["analytics.product"],
      adapterStatus: "IMPLEMENTED",
      lifecycle: "IMPLEMENTED",
      requiredEnvironmentVariables: [
        "POSTHOG_ENABLED",
      ...
      supportedCurrencies: ["EUR", "CHF"],
      evidence: [
        "Consent-gated browser and server adapters use the EU host from runtime configuration.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        ["analytics.product"],
        "P3",
        "frontend/src/analytics/providers/ga4.provider.ts",
      ...
      supportedCurrencies: ["EUR", "CHF"],
      evidence: [
        "Optional marketing-consent browser adapter and server Measurement Protocol adapter.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        ["analytics.product"],
        "P3",
        "frontend/src/analytics/providers/matomo.provider.ts",
      ...
      supportedCurrencies: ["EUR", "CHF"],
      evidence: [
        "Optional consent-gated cookieless browser and server Tracking API adapters.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        ["analytics.rum"],
        "P3",
        "frontend/src/analytics/cloudflare-web-analytics.ts",
        "https://developers.cloudflare.com/web-analytics/",
      ),
      implementedCapabilities: ["analytics.rum"],
      adapterStatus: "IMPLEMENTED",
      lifecycle: "IMPLEMENTED",
      requiredEnvironmentVariables: [
        "NEXT_PUBLIC_CLOUDFLARE_ANALYTICS_ENABLED",
      ...
      supportedCurrencies: [],
      evidence: [
        "Single production-only module beacon, loaded only after analytics consent; no custom-event duplication.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        ["analytics.seo"],
        "P2",
        "backend/src/workers/analytics/search-console-worker.ts",
        "https://developers.google.com/webmaster-tools/v1/searchanalytics/query",
      ),
      implementedCapabilities: ["analytics.seo"],
      adapterStatus: "IMPLEMENTED",
      lifecycle: "IMPLEMENTED",
      requiredEnvironmentVariables: [
        "SEARCH_CONSOLE_ENABLED",
        "SEARCH_CONSOLE_SERVICE_ACCOUNT_JSON",
        "SEARCH_CONSOLE_SITE_URLS",
      ],
      healthCheckKind: "CONFIGURATION_ONLY",
      supportedMarkets: ["*"],
      supportedCurrencies: [],
      evidence: [
        "Idempotent finalized-data ingestion is paginated and resolves every page to a Shongre market.",
      ],
      blockers: [],
    },
    {
      ...planned(
        ...
        "P1",
        "backend/src/infrastructure/observability/sentry.ts",
        "https://docs.sentry.io/",
      ),
      implementedCapabilities: ["monitoring.error_tracking"],
      adapterStatus: "IMPLEMENTED",
      lifecycle: "IMPLEMENTED",
      requiredEnvironmentVariables: ["SENTRY_ENABLED", "SENTRY_DSN"],
      optionalEnvironmentVariables: ["SENTRY_TRACES_SAMPLE_RATE"],
      healthCheckKind: "CONFIGURATION_ONLY",
      supportedMarkets: ["*"],
      supportedCurrencies: [],
      evidence: [
        "Frontend and backend reporters remove request data, user identity and sensitive breadcrumbs before send.",
      ],
      blockers: [],
    },
    planned(
...
export const SHONGRE_CAPABILITY_REQUIREMENTS: readonly ProviderCapabilityRequirement[] =
  [
    {
      domain: "Analytics",
      capability: "analytics.authoritative_reporting",
      label: "Authoritative marketplace reporting",
      requirement: "REQUIRED",
      criticality: "P1",
      markets: ["*"],
      primaryProviderId: "shongre_analytics",
      gracefulDegradation:
        "Preserve operational ledgers and defer aggregate refresh; never replace finance-backed revenue with browser events.",
    },
    {
      domain: "Analytics",
      capability: "analytics.product",
      label: "Product intelligence",
      requirement: "RECOMMENDED",
      criticality: "P2",
      markets: ["*"],
      primaryProviderId: "posthog",
      fallbackProviderId: "shongre_analytics",
      gracefulDegradation:
        "Use the internal consent-aware event ledger and retain provider-neutral event semantics.",
    },
    {
      domain: "Analytics",
      capability: "analytics.seo",
      label: "Search performance intelligence",
      requirement: "RECOMMENDED",
      criticality: "P2",
      markets: ["*"],
      primaryProviderId: "google_search_console",
      gracefulDegradation:
        "Keep the last finalized snapshot and surface synchronization staleness.",
    },
    {
    ...
    },
    {
      ...
      label: "Privacy-safe error monitoring",
      requirement: "RECOMMENDED",
      criticality: "P1",
      markets: ["*"],
      primaryProviderId: "sentry",
      gracefulDegradation:
        "Preserve structured application logs and request identifiers without exposing sensitive payloads.",
    },
    {
