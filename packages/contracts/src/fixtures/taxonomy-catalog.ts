export type CanonicalTaxonomyLevel =
...
const IDENTITIES: readonly TaxonomyIdentityTuple[] = [
  ...
  [
    "sports_outdoors.outdoor",
    "SPORT_OUTDOOR",
    "randonnee-camping-ski",
