...
export interface Database {
  public: {
    Tables: {
      ...
      organization_branches: GeneratedTable<{
        id: string;
      ...
      organization_members: GeneratedTable<{
        organization_id: string;
        user_id: string;
      ...
      listings: {
        Row: {
          ...
          publisher_type: "private" | "professional";
          publisher_user_id: string;
          publisher_organization_id: string | null;
          publisher_branch_id: string | null;
          publisher_verification_status:
            ...
            | "business_verified"
            | "suspended";
          publication_offer_id: string | null;
          ...
          promotion_source:
            "purchase" | "subscription_credit" | "admin_grant" | null;
          promotion_source_id: string | null;
      ...
      categories: {
        Row: {
          ...
          level: "category" | "subcategory" | "type" | "subtype" | null;
          icon_name: string;
          sort_order: number;
          is_active: boolean;
          status: string;
          publishable: boolean;
          listing_family: string | null;
          ...
          schema_status: "draft" | "published" | "deprecated";
          ...
          media_guidance: Json;
          seo_config: Json;
          active_market_codes: string[];
          premium_feature_availability: Json;
      ...
      taxonomy_versions: GeneratedTable<{
        id: string;
      ...
      taxonomy_attributes: GeneratedTable<{
        id: string;
        code: string;
        label: string;
        labels: Json;
      ...
      taxonomy_node_attributes: GeneratedTable<{
        node_id: string;
        attribute_id: string;
      ...
      taxonomy_aliases: GeneratedTable<{
        alias: string;
        canonical_node_id: string;
        alias_kind: "id" | "slug" | "label" | "translation";
        redirect_path: string;
        status: "active" | "retired";
        created_at: string;
      }>;
      taxonomy_merge_mappings: GeneratedTable<{
        source_node_id: string;
        canonical_node_id: string;
        source_slug: string;
        listing_count_before: number;
        saved_search_count_before: number;
        attribute_count_before: number;
      ...
      push_device_tokens: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["push_device_tokens"]["Insert"]
        >;
        Relationships: [];
      };
      course_market_configs: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_market_configs"]["Insert"]
        >;
        Relationships: [];
      };
      course_subject_levels: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_subject_levels"]["Insert"]
        >;
        Relationships: [];
      };
      course_subjects: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_subjects"]["Insert"]
        >;
        Relationships: [];
      };
      course_plans: {
      ...
      course_tutor_profiles: {
        Row: {
          ...
          schema_version: number;
          slug: string;
          profile_type: "individual" | "organization_member";
          headline: string;
          biography: string;
          ...
          rating: number | null;
          review_count: number;
          rating_is_statistically_meaningful: boolean;
          is_featured: boolean;
          public_payload: Json;
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_tutor_profiles"]["Insert"]
        >;
        Relationships: [];
      };
      course_offers: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_offers"]["Insert"]
        >;
        Relationships: [];
      };
      course_learner_requests: {
        Row: {
          ...
          learner_age_band: "under_13" | "13_15" | "16_17" | "adult";
          guardian_user_id: string | null;
          guardian_consent_confirmed_at: string | null;
          status: "draft" | "submitted" | "matched" | "closed" | "expired";
          private_payload: Json;
          expires_at: string;
          created_at: string;
          updated_at: string;
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_learner_requests"]["Insert"]
        >;
        Relationships: [];
      };
      course_leads: {
        Row: {
          ...
          contact_release_status: "withheld" | "released" | "revoked";
          credit_cost: number;
      ...
      course_bookings: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["course_bookings"]["Insert"]
        >;
        Relationships: [];
      };
      user_identities: {
      ...
      oauth_authorization_flows: {
        Row: {
          ...
          requested_account_type: "individual" | "professional" | null;
          nonce_hash: string;
        ...
        Update: Partial<
          Database["public"]["Tables"]["oauth_authorization_flows"]["Insert"]
        >;
        Relationships: [];
      };
      oauth_native_exchanges: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["oauth_native_exchanges"]["Insert"]
        >;
        Relationships: [];
      };
      oauth_pending_registrations: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["oauth_pending_registrations"]["Insert"]
        >;
        Relationships: [];
      };
      oauth_provider_deletion_requests: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["oauth_provider_deletion_requests"]["Insert"]
        >;
        Relationships: [];
      };
      auth_rate_limits: {
      ...
      auth_action_tokens: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["auth_action_tokens"]["Insert"]
        >;
        Relationships: [];
      };
      auth_audit_events: {
      ...
      monetization_product_versions: GeneratedTable<{
        ...
        description: string;
        audience:
          "guest" | "individual" | "professional" | "organization" | "all";
        scope: Json;
        compatibility: Json;
        status: CommercialConfigurationStatus;
        is_recommended: boolean;
        source_consumers: string[];
        effective_from: string | null;
        effective_until: string | null;
        created_at: string;
        updated_at: string;
      ...
      monetization_promotions: GeneratedTable<{
        ...
        stacking_policy: "exclusive" | "best_only" | "stackable";
        maximum_redemptions: number | null;
        maximum_redemptions_per_account: number;
        starts_at: string;
        ends_at: string;
        created_at: string;
        updated_at: string;
      ...
      listing_ownership_audit: GeneratedTable<{
        id: string;
        listing_id: string;
        actor_user_id: string | null;
        previous_publisher: Json | null;
        next_publisher: Json;
        reason: string;
        created_at: string;
      }>;
      listing_promotions: GeneratedTable<{
        id: string;
        listing_id: string;
        product_id: string | null;
        placement_type: string;
        source_type: "purchase" | "subscription_credit" | "admin_grant";
        source_order_id: string | null;
        source_entitlement_id: string | null;
        admin_grant_reference: string | null;
        status:
          | "scheduled"
          | "active"
          | "expired"
      ...
      discovery_configuration_versions: GeneratedTable<{
        id: string;
        market_code: string;
        category_id: string | null;
        context: "search" | "home" | "similar" | "saved_search";
        version_number: number;
        status:
          | "draft"
          | "pending_approval"
        ...
        sponsored_policy: Json;
        duplicate_policy: Json;
      ...
      promotion_product_policies: GeneratedTable<{
        product_id: string;
        configuration_version_id: string;
        placement_type: string;
        eligible_market_codes: string[];
        eligible_category_ids: string[];
        eligible_publisher_types: string[];
        ...
        analytics_configuration: Json;
        is_enabled: boolean;
      }>;
      listing_duplicate_reviews: GeneratedTable<{
        id: string;
        listing_id: string;
      ...
      discovery_search_events: GeneratedTable<{
        id: string;
        request_id: string;
        market_code: string;
        category_id: string | null;
      ...
      promotion_impressions: GeneratedTable<{
        impression_id: string;
        listing_promotion_id: string;
        request_id: string;
        session_hash: string;
        position: number;
    ...
    Functions: {
      ...
      consume_oauth_authorization_flow: {
        ...
        Returns: Database["public"]["Tables"]["oauth_authorization_flows"]["Row"][];
      };
      consume_oauth_native_exchange: {
        Args: { p_code_hash: string };
        Returns: Database["public"]["Tables"]["oauth_native_exchanges"]["Row"][];
      };
      consume_oauth_pending_registration: {
        Args: { p_handle_hash: string };
        Returns: Database["public"]["Tables"]["oauth_pending_registrations"]["Row"][];
      };
      consume_auth_action_token: {
        Args: { p_token_hash: string; p_purpose: string };
        Returns: Database["public"]["Tables"]["auth_action_tokens"]["Row"][];
      };
      ...
      provision_oauth_profile: {
        Args: {
          ...
          p_provider_display_name: string | null;
      ...
      consume_monetization_quota: {
        Args: {
          ...
          p_period_end: string;
          p_limit: number;
          p_observed_min?: number;
          p_amount?: number;
        };
        Returns: number;
      };
      claim_monetization_payment_event: {
        Args: {
          p_provider: string;
      ...
      publish_commercial_configuration: {
        Args: { p_version_id: string; p_actor_id: string; p_reason: string };
        Returns: undefined;
      };
      ...
      save_commercial_configuration_version: {
        Args: { p_version: Json; p_catalog: Json; p_snapshot_hash: string };
        Returns: undefined;
      };
      save_monetization_quote: {
        Args: { p_quote: Json; p_idempotency_key: string };
        Returns: Json;
      };
      refresh_listing_effective_promotion: {
        Args: { p_listing_id: string };
        Returns: undefined;
      };
      unified_discovery_migration_dry_run: {
        Args: Record<string, never>;
        Returns: Json;
      };
      publish_discovery_configuration_version: {
        Args: {
          ...
          p_context: "search" | "home" | "similar" | "saved_search";
          p_weights: Json;
          p_freshness_half_life_days: number;
          p_diversity_policy: Json;
          p_sponsored_policy: Json;
      ...
      resolve_taxonomy_alias: {
        Args: { input_alias: string };
        Returns: { canonical_node_id: string; redirect_path: string }[];
      };
    };
    Enums: {
