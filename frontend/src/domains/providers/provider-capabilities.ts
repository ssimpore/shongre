...
export const PROVIDER_CATEGORIES: Record<ProviderCategory, CategoryMetadata> = {
  ...
  PAYOUT: {
    ...
    description: 'Virements bancaires automatisés et transferts instantanés vers les vendeurs.',
    iconName: 'Coins',
  ...
  AUTHENTICATION: {
    ...
    shortLabel: 'Auth & SSO',
    description: 'Connexion sociale Google / Apple, mot de passe sécurisé et validation 2FA/MFA.',
    iconName: 'KeyRound',
  ...
  EMAIL: {
    ...
    shortLabel: 'Email',
    description: 'Envoi d\'emails de confirmation, alertes sécurisées et campagnes de newsletter.',
    iconName: 'Mail',
  ...
  SMS: {
    ...
    name: 'SMS & Codes OTP',
    shortLabel: 'SMS OTP',
    description: 'Envoi de codes de validation SMS et notifications critiques par message.',
    iconName: 'Smartphone',
  ...
  PUSH: {
    ...
    shortLabel: 'Push',
    description: 'Alertes en temps réel sur navigateur et applications mobiles (FCM).',
    iconName: 'Bell',
  ...
  SEARCH: {
    ...
    description: 'Recherche plein texte sur la marketplace et prospection web externe pour le CRM.',
    iconName: 'Search',
  ...
  MAPS: {
    ...
    shortLabel: 'Cartes',
    description: 'Affichage des fonds de carte interactifs et tuiles géographiques.',
    iconName: 'Map',
  ...
  IDENTITY_VERIFICATION: {
    ...
    description: 'Contrôle automatisé des pièces d\'identité et prévention de l\'usurpation.',
    iconName: 'UserCheck',
  ...
  STORAGE: {
    ...
    shortLabel: 'Stockage',
    description: 'Stockage objet d\'images de publications, pièces jointes de litiges et factures.',
    iconName: 'HardDrive',
  ...
  ANALYTICS: {
    ...
    description: 'Mesure de trafic respectueuse de la vie privée (conforme RGPD / sans cookies tiers).',
    iconName: 'BarChart3',
  ...
  CAPTCHA: {
    ...
    shortLabel: 'CAPTCHA',
    description: 'Protection invisible contre le spam et les bots sur les formulaires sensibles.',
  ...
  CRM: {
    ...
    shortLabel: 'CRM',
    description: 'Synchronisation et enrichissement de données entreprises externes.',
    iconName: 'Briefcase',
  ...
  INVOICING: {
    ...
    description: 'Génération de factures Pro et conformité facturation électronique.',
    iconName: 'FileText',
...
export const PROVIDER_CAPABILITIES: Record<ProviderCapability, CapabilityMetadata> = {
  // Payment
  'payment.card': {
    id: 'payment.card',
    category: 'PAYMENT',
    name: 'Paiement par Carte Bancaire',
    description: 'Encaissement sécurisé CB, Visa, Mastercard avec protocole 3D Secure v2.',
    usedByFeatures: ['Achat direct', 'Réservation avec séquestre', 'Abonnements Pro', 'Options de boost'],
  ...
  'payment.wallet': {
    ...
    description: 'Paiement en 1 clic via Apple Pay et Google Pay sur mobile et web.',
  ...
  'payment.sepa': {
    ...
    description: 'Paiement direct par compte bancaire SEPA pour montants élevés.',
  ...
  'payment.escrow': {
    ...
    description: 'Conservation sécurisée des fonds sur compte de cantonnement jusqu\'à la remise conforme.',
  ...
  'payment.refund': {
    ...
    description: 'Déclenchement des remboursements totaux ou partiels en cas d\'annulation ou litige.',
  ...
  'payout.transfer': {
    ...
    description: 'Virement SEPA régulier sous 24 à 48h une fois la transaction finalisée.',
  ...
  'payout.instant': {
    ...
    description: 'Crédit immédiat des fonds sur le compte bancaire du vendeur en moins de 10 secondes.',
  ...
  'delivery.relay_point': {
    ...
    description: 'Dépôt et retrait en commerce partenaire ou casier automatique.',
  ...
  'delivery.home_delivery': {
    ...
    description: 'Acheminement postal ou transporteur jusqu\'au domicile de l\'acheteur.',
  ...
  'delivery.bulky': {
    ...
    description: 'Covoiturage de colis et transporteurs spécialisés pour meubles et pièces lourdes.',
  ...
  'delivery.quote': {
    ...
    description: 'Estimation temps réel des tarifs d\'envoi selon gabarit et destination.',
  ...
  'delivery.tracking': {
    ...
    description: 'Synchronisation des statuts d\'acheminement et notifications d\'étapes.',
  ...
  'delivery.label': {
    ...
    description: 'Création instantanée des bordereaux d\'expédition PDF prépayés.',
  ...
  'auth.email_password': {
    ...
    description: 'Gestion des comptes locaux Shongre avec hachage sécurisé et réinitialisation.',
  ...
  'auth.mfa_totp': {
    ...
    description: 'Code temporaire 6 chiffres via application d\'authentification (Google Auth, Authy).',
  ...
  'auth.session': {
    ...
    description: 'Génération et révocation des sessions sécurisées côté serveur.',
  ...
  'email.transactional': {
    ...
    description: 'Envoi des confirmations d\'achat, codes PIN, alertes litiges et réinitialisations de mot de passe.',
  ...
  'email.marketing': {
    ...
    description: 'Envoi des newsletters thématiques, digests hebdomadaires et communications promotionnelles.',
  ...
  'sms.otp': {
    ...
    description: 'Envoi des codes de vérification de numéro de téléphone mobile.',
  ...
  'sms.transactional': {
    ...
    description: 'Alertes SMS pour remise en main propre imminente ou confirmation d\'achat.',
  ...
  'push.web': {
    ...
    description: 'Notifications PWA / navigateur pour nouveaux messages et offres.',
  ...
  'ai.listing_assistance': {
    ...
    description: 'Génération de titres percutants, descriptions structurées et estimation tarifaire.',
  ...
  'ai.safety_audit': {
    ...
    description: 'Analyse automatique des annonces pour détecter contrefaçons, escroqueries et items prohibés.',
  ...
  'ai.prospect_research': {
    ...
    description: 'Découverte de prospects professionnels via recherche web et synthèse de pertinence.',
  ...
  'ai.company_enrichment': {
    ...
    description: 'Extraction automatique d\'informations d\'entreprises (effectif, secteur, catalogue).',
  ...
  'search.marketplace': {
    ...
    description: 'Indexation rapide, recherche tolérante aux fautes, facettes et filtres de recherche.',
  ...
  'search.public_web': {
    ...
    description: 'Interrogation du web public pour alimenter les recherches d\'entreprises cibles.',
  ...
  'maps.display': {
    ...
    description: 'Affichage des fonds de carte et marqueurs de localisation géographique.',
    usedByFeatures: ['Fiche annonce', 'Recherche géographique', 'Sélecteur de territoire'],
    isRedundancyRecommended: false,
  },
  'maps.geocode': {
    id: 'maps.geocode',
    ...
    description: 'Conversion d\'une adresse ou code postal en latitude et longitude.',
  ...
  'maps.reverse_geocode': {
    ...
    description: 'Détermination de la commune et code postal à partir d\'un point GPS.',
  ...
  'maps.autocomplete': {
    ...
    description: 'Suggestions d\'adresses en temps réel pendant la saisie utilisateur.',
    usedByFeatures: ['Formulaires d\'adresse de livraison', 'Saisie de localisation'],
    isRedundancyRecommended: true,
  },
  ...
  'verification.identity': {
    ...
    name: 'Vérification d\'Identité (KYC)',
    description: 'Analyse biométrique et contrôle d\'authenticité des passeports et CNI.',
  ...
  'verification.business': {
    ...
    description: 'Vérification de l\'immatriculation légale et de l\'état d\'activité des pros.',
  ...
  'verification.vat': {
    ...
    description: 'Interrogation de la base VIES pour valider l\'assujettissement TVA européen.',
  ...
  'storage.media': {
    ...
    description: 'Hébergement haute disponibilité des photographies et galeries d\'annonces.',
  ...
  'storage.document': {
    ...
    description: 'Stockage sécurisé à accès restreint pour pièces d\'identité et factures PDF.',
  ...
  'cdn.delivery': {
    ...
    description: 'Mise en cache et diffusion ultra-rapide des assets statiques.',
  ...
  'analytics.product': {
    ...
    description: 'Comptabilisation des vues d\'annonces et métriques de conversion sans cookies.',
  ...
  'monitoring.error_tracking': {
    ...
    description: 'Détection et diagnostic des erreurs d\'exécution du client web.',
  ...
  'invoicing.subscription': {
    ...
    description: 'Émission mensuelle ou annuelle des factures d\'abonnements aux forfaits Pro.',
  ...
  'invoicing.electronic': {
    ...
    description: 'Génération de factures structurées XML/PDF conformes à la réglementation B2B.',
  ...
  'security.captcha': {
    ...
    description: 'Vérification non intrusive pour bloquer les attaques automatisées.',
  ...
  'security.fraud_risk': {
    ...
    description: 'Évaluation du score de risque des comptes et des transactions en ligne.',
...
export function getCapabilitiesByCategory(category: ProviderCategory): CapabilityMetadata[] {
  return Object.values(PROVIDER_CAPABILITIES).filter((c) => c.category === category);
}

export function getCategoryMetadata(category: ProviderCategory): CategoryMetadata {
...
export function getCapabilityMetadata(capability: ProviderCapability): CapabilityMetadata {
