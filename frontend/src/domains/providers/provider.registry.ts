...
export const CANONICAL_PROVIDER_REGISTRY: Provider[] = [
  // 1. MangoPay Escrow & Payments
  {
    ...
    metadata: {
      ...
      complianceNotes: 'Agréé Établissement de Monnaie Électronique (EME) par la CSSF sous le numéro 3812.',
    },
  },
  ...
  // 5. Chronopost Express
  {
    ...
    metadata: {
      ...
      documentationUrl: 'https://www.chronopost.fr/fr/entreprises/solutions-e-commerce/api',
  ...
  // 10. Brevo (Marketing & Transactional Email / Newsletter)
  {
    ...
    category: 'EMAIL',
    capabilities: ['email.marketing', 'email.transactional', 'sms.transactional'],
    supportedMarkets: ['*'],
    supportedCurrencies: ['EUR', 'CHF'],
    supportedLocales: ['fr-FR', 'en-US', 'es-ES', 'de-DE'],
    integrationReadiness: 'implemented_demo',
      ...
      fields: [
        ...
        },
        {
          ...
          options: [
            ...
            { value: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro (Raisonnement Avancé)' },
          ],
        },
      ],
    },
    ...
    configurationSchema: {
      fields: [
        ...
        },
        {
          ...
          label: 'Utiliser l\'API gouvernementale BAN en priorité pour la France',
          type: 'boolean',
          defaultValue: true,
        },
      ],
...
export function getProvidersByCapability(capability: Provider['capabilities'][number]): Provider[] {
  return CANONICAL_PROVIDER_REGISTRY.filter((p) => p.capabilities.includes(capability));
}
