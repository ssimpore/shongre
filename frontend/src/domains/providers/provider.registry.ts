...
const PROVIDER_PRESENTATION_REGISTRY: Array<Omit<Provider, "operational">> = [
  ...
  // Unified analytics control plane. Provider cards are presentation only;
  // operational readiness comes from packages/contracts/provider-platform.ts.
  {
    id: "shongre_analytics",
    code: "SHONGRE_ANALYTICS",
    name: "Shongre Internal Analytics",
    category: "ANALYTICS",
    capabilities: ["analytics.product"],
    supportedMarkets: ["*"],
    supportedCurrencies: ["EUR", "CHF"],
    supportedLocales: ["fr-FR", "fr-BE", "fr-CH", "en-US"],
    integrationReadiness: "production_ready",
    isCustomizablePerMarket: false,
    configurationSchema: { fields: [] },
    metadata: {
      documentationUrl: "/backend/docs/analytics.md",
      documentationLabel: "Architecture analytics Shongre",
      companyName: "Shongre",
      headquartersCountry: "France",
      complianceNotes:
        "Entrepôt interne, RLS, rétention et anonymisation pilotés par migrations.",
    },
  },
  {
    id: "posthog",
    ...
    supportedCurrencies: ["EUR", "CHF"],
    supportedLocales: ["fr-FR", "fr-BE", "fr-CH", "en-US"],
    integrationReadiness: "implemented_unverified",
    isCustomizablePerMarket: false,
    configurationSchema: {
      fields: [
        {
          key: "projectKey",
          label: "Clé projet PostHog",
          type: "password",
          secret: true,
          required: true,
        },
    ...
    metadata: {
      ...
      documentationLabel: "Documentation PostHog",
      companyName: "PostHog Inc.",
      headquartersCountry: "États-Unis",
      complianceNotes:
        "Hôte EU obligatoire et initialisation après consentement analytics.",
    },
  },
  {
    id: "ga4",
    code: "GOOGLE_ANALYTICS_4",
    name: "Google Analytics 4 (optionnel)",
    category: "ANALYTICS",
    capabilities: ["analytics.product"],
    supportedMarkets: ["*"],
    supportedCurrencies: ["EUR", "CHF"],
    ...
    configurationSchema: {
      fields: [
        ...
        {
          key: "apiSecret",
          label: "Secret Measurement Protocol",
          type: "password",
          secret: true,
        },
      ],
    ...
    metadata: {
      ...
      documentationLabel: "Documentation GA4",
      companyName: "Google Ireland Limited",
      headquartersCountry: "Irlande (UE)",
      complianceNotes: "Classé marketing et désactivé par défaut.",
    },
  },
  {
    id: "matomo",
    code: "MATOMO",
    name: "Matomo (optionnel)",
    category: "ANALYTICS",
    capabilities: ["analytics.product"],
    supportedMarkets: ["*"],
    supportedCurrencies: ["EUR", "CHF"],
    ...
    configurationSchema: {
      fields: [
        { key: "url", label: "URL Matomo", type: "url", required: true },
    ...
    metadata: {
      ...
      documentationUrl: "https://developer.matomo.org/",
      documentationLabel: "Documentation Matomo",
      companyName: "InnoCraft Ltd.",
      headquartersCountry: "Nouvelle-Zélande",
      complianceNotes:
        "Adaptateur navigateur sans cookies et soumis au consentement analytics.",
    },
  },
  {
    id: "cloudflare_web_analytics",
    code: "CLOUDFLARE_WEB_ANALYTICS",
    ...
    metadata: {
      ...
      documentationUrl: "https://developers.cloudflare.com/web-analytics/",
      documentationLabel: "Documentation Cloudflare Web Analytics",
      companyName: "Cloudflare Inc.",
      headquartersCountry: "États-Unis",
      complianceNotes:
        "RUM de production uniquement; aucun événement produit personnalisé.",
    },
  },
  {
    ...
    configurationSchema: {
      fields: [
        {
          key: "siteUrls",
          label: "Propriétés Search Console",
          type: "multi-select",
          required: true,
        },
        {
          key: "serviceAccount",
          label: "Compte de service JSON",
          type: "password",
          secret: true,
          required: true,
        },
    ...
    metadata: {
      ...
      documentationLabel: "API Search Analytics",
      companyName: "Google Ireland Limited",
      headquartersCountry: "Irlande (UE)",
    },
  },
  ...
  // Error tracking and APM
  {
    ...
    metadata: {
      ...
      documentationLabel: "Documentation Sentry",
      companyName: "Functional Software Inc. (Sentry)",
      headquartersCountry: "États-Unis",
      complianceNotes:
        "PII par défaut désactivée et données de requête supprimées avant envoi.",
    },
  },
