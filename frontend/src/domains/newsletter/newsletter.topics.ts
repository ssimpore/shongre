...
export const NEWSLETTER_TOPICS: NewsletterTopicDefinition[] = [
  {
    ...
    description:
      "Recevez les meilleures affaires du moment et les baisses de prix vérifiées.",
  ...
  },
  {
    ...
    description:
      "Une sélection soignée d'annonces uniques, d'objets vintage et de pépites locales.",
  ...
  },
  {
    ...
    description:
      "Astuces photos, conseils de tarification et bonnes pratiques pour vos annonces.",
    audience: { individual: true, professional: false },
  ...
  },
  {
    ...
    description:
      "Statistiques sectorielles, astuces pour booster vos ventes et actualités fiscales/légales.",
  ...
  },
  {
    ...
    description:
      "Découvrez les nouvelles fonctionnalités, options de livraison et améliorations produit.",
    audience: { individual: true, professional: true },
    defaultEnabled: true,
  },
  {
    ...
    description:
      "L'actualité des annonces et rassemblements locaux autour de votre ville.",
    audience: { individual: true, professional: true },
    defaultEnabled: false,
  },
];
...
export class NewsletterTopicsService {
  ...
  getTopicsForAudience(isPro: boolean): NewsletterTopicDefinition[] {
    return NEWSLETTER_TOPICS.filter((t) =>
      isPro ? t.audience.professional : t.audience.individual,
    );
  }
