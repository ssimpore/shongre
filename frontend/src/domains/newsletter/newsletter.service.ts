    ...
    switch (status) {
      case "subscribed":
        return {
          ...
          variant: "success",
          description:
            "Vous recevez les actualités et sélections Shongre selon vos préférences.",
        };
      ...
      case "unsubscribed":
        return {
          ...
          variant: "neutral",
          description:
            "Vous ne recevez plus les communications promotionnelles et éditoriales.",
        };
      case "suppressed":
        return {
          label: "Suspendu",
          variant: "neutral",
          description:
            "Votre adresse est temporairement exclue des envois suite à un échec de distribution.",
        };
    }
  }
}
