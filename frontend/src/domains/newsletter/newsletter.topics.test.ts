...
describe("Newsletter Topics & Capabilities", () => {
  ...
  it("filters topics by audience (individual vs professional)", () => {
    const individualTopics =
      newsletterTopicsService.getTopicsForAudience(false);
