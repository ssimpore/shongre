...
describe('NotificationService', () => {
  const createMockNotif = (id: string, category: any, isRead: boolean, createdAt: string): Notification => ({
    id,
  ...
  it('filters notifications by tab correctly', () => {
    ...
    // Filter messages
    const messages = notificationService.filterNotifications(notifs, 'messages');
