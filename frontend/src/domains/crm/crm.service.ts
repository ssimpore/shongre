...
export const PIPELINE_STAGES: StageMetadata[] = [
  ...
  },
  {
    ...
    description: "Intérêt confirmé et fit validé",
  },
  {
    id: "contacted",
    label: "Contacté",
    ...
    description: "Premier échange ou démo planifiée",
  },
  {
    id: "proposal",
    label: "Proposition",
    ...
    description: "Devis ou offre Pro soumise",
  },
  {
    id: "negotiation",
    label: "Négociation",
    ...
    description: "Discussion contractuelle en cours",
  },
  {
    id: "won",
    label: "Gagné (Converti)",
    order: 6,
    color: "bg-success-surface text-success",
    description: "Vendeur Pro actif / contrat signé",
  },
  {
    id: "lost",
    label: "Perdu",
    ...
    description: "Sans suite ou refus",
  },
];
...
export class CrmService {
    ...
    switch (qualification) {
      ...
      case "medium":
        return {
          ...
          badgeClass: "bg-warning-surface text-warning",
        };
      case "low":
        return {
  ...
  detectDuplicate(
    ...
    const candDomain =
      candidate.domain ||
      (candidate.website ? this.normalizeDomain(candidate.website) : "");
    const candName = candidate.name.toLowerCase().trim();

    for (const company of existingCompanies) {
      const compDomain =
        company.domain ||
        (company.website ? this.normalizeDomain(company.website) : "");
