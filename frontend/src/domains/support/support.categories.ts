...
export const SUPPORT_CATEGORIES: SupportCategoryDefinition[] = [
  {
    ...
    description: 'Difficultés de connexion, mot de passe, vérification d\'email ou profil.',
    iconName: 'User',
    reasons: [
      {
        id: 'account_login_issue',
        label: 'Impossible de me connecter à mon compte',
        helpTip: 'Vous pouvez utiliser la procédure de réinitialisation de mot de passe par email.',
...

  {
    ...
    description: 'Aide à la publication, modification, rejet ou expiration d\'annonce.',
    iconName: 'Tag',
    reasons: [
      {
        id: 'listing_cannot_publish',
        label: 'Impossible de publier une annonce (erreur formulaire)',
        helpTip: 'Vérifiez que tous les champs obligatoires et au moins une photo sont renseignés.',
        defaultPriority: 'normal',
      },
      {
        id: 'listing_rejected_appeal',
        label: 'Mon annonce a été refusée ou suspendue',
        helpTip: 'Consultez le motif de refus dans vos notifications avant de solliciter le support.',
        defaultPriority: 'normal',
      },
      {
...

  {
    ...
    description: 'Suivi de commande, confirmation d\'achat direct ou question acheteur.',
    iconName: 'ShoppingBag',
    reasons: [
      {
        id: 'purchase_status_inquiry',
        label: 'Où en est ma commande ?',
        helpTip: 'Vous pouvez suivre l\'état d\'expédition directement depuis « Mes achats ».',
        defaultPriority: 'normal',
      },
      {
        id: 'purchase_contact_seller',
        label: 'Contacter le vendeur de l\'article',
        helpTip: 'Pour échanger avec le vendeur, utilisez directement la messagerie intégrée.',
        isMessagingHandoff: true,
      },
      {
        id: 'purchase_item_not_received',
        label: 'Article non reçu ou non conforme (Litige)',
        helpTip: 'Pour bloquer les fonds sous séquestre, ouvrez un litige formel depuis la commande.',
...

  {
    ...
    description: 'Gestion d\'une commande reçue, remise en main propre ou libération des fonds.',
    iconName: 'DollarSign',
    reasons: [
      {
        id: 'sale_funds_not_released',
        label: 'Quand mes fonds seront-ils versés ?',
        helpTip: 'Les fonds sont débloqués dès confirmation de réception conforme ou validation du code PIN.',
        defaultPriority: 'normal',
      },
      {
...

  {
    ...
    description: 'Paiement refusé, carte bancaire, séquestre ou remboursement en attente.',
    iconName: 'CreditCard',
    reasons: [
      {
        id: 'payment_refused',
        label: 'Mon paiement par carte est refusé',
        helpTip: 'Vérifiez la validation 3D Secure sur votre application bancaire.',
        defaultPriority: 'normal',
      },
      {
      ...
      },
      {
        ...
        helpTip: 'Les remboursements bancaires prennent généralement 2 à 4 jours ouvrés.',
        defaultPriority: 'normal',
      },
      {
        id: 'payment_other',
...

  {
    ...
    description: 'Vérification SIRET, forfait Pro, factures ou outils boutique.',
    iconName: 'Briefcase',
    reasons: [
      {
    ...
    reasons: [
      {
        ...
        helpTip: 'Ne communiquez jamais vos coordonnées bancaires ou codes SMS.',
        defaultPriority: 'urgent',
      },
      {
        id: 'safety_report_user',
        label: 'Signaler une annonce illégale ou un utilisateur abusif',
        helpTip: 'Vous pouvez utiliser le bouton « Signaler » directement sur l\'annonce ou la conversation.',
...

  {
    ...
    description: 'Partenariat, presse, question générale ou retour d\'expérience.',
    iconName: 'HelpCircle',
    reasons: [
      {
        id: 'general_question',
...
export class SupportCategoriesService {
  getCategory(categoryId: SupportCategory): SupportCategoryDefinition | undefined {
    return SUPPORT_CATEGORIES.find((c) => c.id === categoryId);
  }

  getReason(categoryId: SupportCategory, reasonId: string): SupportReasonDefinition | undefined {
