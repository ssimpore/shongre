...
const DEMO_FURNITURE_PROSPECTS: ProspectResearchCandidate[] = [
  {
    ...
    company: {
      ...
      description:
        "Boutique spécialisée dans le mobilier scandinave des années 50-70 et l'éclairage vintage.",
    ...
    sources: [
      {
        ...
        snippet:
          "Spécialistes du design vintage scandinave depuis 2014 dans le 11ème arrondissement de Paris...",
      ...
      },
      {
        ...
        snippet:
          "Commerce de détail de meubles. SIREN 814 291 002. Chiffre d'affaires en croissance...",
  ...
  },
  {
    ...
    company: {
      ...
      description:
        "Créateur et restaurateur de tables sur mesure en chêne massif et acier.",
    ...
    sources: [
      {
        ...
        snippet:
          "Créations sur mesure et pièces uniques fabriquées en Île-de-France...",
        sourceType: "Site web officiel",
        retrievedAt: "2026-08-17T00:00:00Z",
      },
    ],
  ...
  },
  {
    ...
    company: {
      ...
      description:
        "Antiquaire généraliste proposant miroirs anciens, pendules et commodes d'époque.",
    ...
    fit: {
      ...
      caveats: [
        "Présence e-commerce limitée, nécessite un accompagnement à la publication",
      ],
    },
    sources: [
      {
...
const DEMO_EV_PROSPECTS: ProspectResearchCandidate[] = [
  {
    ...
    company: {
      ...
      description:
        "Distributeur et installateur certifié IRVE de bornes de recharge pour particuliers et pros.",
    ...
    sources: [
      {
        ...
        snippet:
          "Vente directe et packs installation pour véhicules électriques...",
        sourceType: "Site web officiel",
        retrievedAt: "2026-08-17T00:00:00Z",
      },
    ],
  ...
  },
  {
    ...
    company: {
      ...
      description:
        "Solutions de recharge couplées au solaire pour maisons individuelles et copropriétés.",
...
export class DemoProspectResearchService implements IProspectResearchService {
  async searchProspects(
    ...
    const isAiAvailable = providerService.isCapabilityAvailable(
  ...
  async enrichCompany(companyId: string): Promise<CompanyEnrichmentDiff> {
    ...
    return {
      ...
      suggestedSummary:
        "Atelier artisanal spécialisé dans le mobilier d'exception avec vitrine e-commerce et atelier physique.",
