...
export const messagesEn: MessageCatalogue = {
  ...
  "watch.meta.description":
    "Manage price drops, followed sellers and saved searches.",
  "watch.title": "My followed alerts",
  "watch.description": "Active alerts for the {market} marketplace.",
  "watch.status.active": "Active",
  "watch.status.paused": "Paused",
  "watch.lastNotified": "last alert",
  "watch.frequency.label": "Alert frequency",
  "watch.frequency.immediate": "Immediately",
  "watch.frequency.daily": "Daily digest",
  "watch.frequency.weekly": "Weekly digest",
  "watch.type.listingPrice": "Price drop",
  "watch.type.seller": "Followed seller",
  "watch.type.savedSearch": "Saved search",
  "watch.channels.label": "Alert channels",
  "watch.channel.inApp": "In Shongre",
  "watch.channel.email": "Email",
  "watch.channel.push": "Mobile notification",
  "watch.action.pause": "Pause",
  "watch.action.resume": "Resume",
  "watch.action.remove": "Remove alert",
  "watch.feedback.updated": "Alert preferences updated.",
  "watch.feedback.removed": "Alert removed.",
  "watch.feedback.channelRequired": "Keep at least one channel enabled.",
  "watch.error.title": "Alerts unavailable",
  "watch.error.loading": "Your alerts could not be loaded.",
  "watch.error.updating": "This alert could not be updated.",
  "watch.error.removing": "This alert could not be removed.",
  "watch.empty.title": "No active alerts",
  ...
  "watch.save.criteriaRequired":
    "Add at least one keyword, category, city or price.",
  "watch.save.queryTitle": "Search “{query}”",
  "watch.save.categoryTitle": "Category {category}",
  "watch.save.customTitle": "My custom search",
  "watch.auto.loginRequired": "Sign in to save this Auto alert.",
  "watch.auto.queryTitle": "Auto · {query}",
  "watch.auto.makeTitle": "Auto · {make}",
  "watch.auto.allVehicles": "All vehicles",
  "watch.auto.success": "Auto alert saved for these criteria.",
  "watch.auto.error": "This Auto alert could not be created.",
  "watch.immo.catalogLoading":
    "The real-estate configuration is still loading.",
  "watch.immo.title": "{transaction} · {location}",
  "watch.immo.sale": "Buy",
  "watch.immo.rental": "Rent",
  "watch.immo.defaultLocation": "Lyon and surrounding area",
  "watch.immo.success":
    "Real-estate alert created. You can manage it from your account.",
  "watch.immo.error": "This real-estate alert could not be created.",
  "watch.savedSearch.removed": "Saved search and alert removed.",
  "watch.savedSearch.removeError": "This saved search could not be removed.",
  ...
  "watch.listing.created": "Alert enabled.",
  "watch.listing.removed": "Alert disabled.",
  "account.navigation.more": "More",
  ...
  "listing.field.brand": "Brand",
  "listing.field.model": "Model",
  "listing.field.year": "Year",
  "listing.field.mileage": "Mileage",
  "listing.field.fuel": "Fuel",
  "listing.field.gearbox": "Gearbox",
  "listing.field.critair": "Crit’Air sticker",
  "listings.pricing.itemPrice": "Listing price",
  "listings.pricing.buyerProtection": "Buyer protection",
  "listings.pricing.delivery": "Delivery",
  "listings.pricing.total": "Total",
  "listings.pricing.dependsOnFulfillment": "Depends on handover method",
  "listings.pricing.dependsOnChoice": "Depends on the selected option",
  "listings.pricing.confirmedBeforePayment": "Confirmed before payment",
  "listings.listingDetailPage.acheterMaintenant": "Buy now",
  "common.back": "Back",
  ...
  "solutions.header.navigationLabel": "Solutions navigation",
  "solutions.header.solutions": "Solutions",
  "solutions.header.ecosystem": "Ecosystem",
  "solutions.header.platform": "Shongre platform",
  "solutions.header.account": "My account",
  "solutions.header.accountShort": "Account",
  "solutions.header.signIn": "Sign in",
  "solutions.header.discover": "Explore solutions",
  "solutions.header.openMenu": "Open menu",
  "solutions.header.closeMenu": "Close menu",
  "solutions.footer.informationLabel": "Solutions information",
  "solutions.footer.about": "About",
  "solutions.footer.documentation": "Documentation",
  "solutions.footer.security": "Security",
  "solutions.footer.cookies": "Cookie settings",
  "solutions.catalog.metaTitle":
    "Shongre Solutions — All your professional applications",
  "solutions.catalog.metaDescription":
    "Enable the solutions your organisation needs and access every workspace with one Shongre account.",
  "solutions.catalog.heroTitle": "All your Shongre tools in one place.",
  "solutions.catalog.heroDescription":
    "Enable the solutions your organisation needs and access every workspace without multiplying accounts.",
  "solutions.catalog.count_one": "{count} solution",
  "solutions.catalog.count_other": "{count} solutions",
  "solutions.catalog.marketLabel": "Catalogue market",
  "solutions.catalog.title": "Shongre solutions catalogue",
  "solutions.catalog.loading": "Loading catalogue",
  "solutions.catalog.errorTitle": "Catalogue unavailable",
  "solutions.catalog.errorDescription": "The catalogue could not be loaded.",
  "solutions.catalog.emptyTitle": "No solutions for this market",
  "solutions.catalog.emptyDescription":
    "The catalogue grows progressively across supported countries and languages.",
  "solutions.catalog.learnMore": "Learn more",
  "solutions.catalog.ecosystemTitle":
    "One account. One organisation. Multiple solutions.",
  "solutions.catalog.securityTitle": "Security and control",
  "solutions.catalog.securityDescription":
    "Your data is protected and your access stays under control.",
  "solutions.catalog.collaborationTitle": "Collaborative work",
  "solutions.catalog.collaborationDescription":
    "Invite your teams and share workspaces.",
  "solutions.catalog.evolutionTitle": "Solutions that evolve",
  "solutions.catalog.evolutionDescription":
    "New capabilities join the same Shongre foundation.",
  "solutions.detail.metaMissingTitle": "Solution not found — Shongre",
  "solutions.detail.metaTitle": "{name} — Shongre Solutions",
  "solutions.detail.metaMissingDescription":
    "This Shongre solution is unavailable.",
  "solutions.detail.unavailableTitle": "Solution unavailable",
  "solutions.detail.loadError": "The solution could not be loaded.",
  "solutions.detail.notFoundTitle": "Solution not found",
  "solutions.detail.notFoundDescription":
    "This address does not match a public solution in the catalogue.",
  "solutions.detail.backToAll": "All solutions",
  "solutions.detail.availableIn": "Available in {markets}",
  "solutions.detail.capabilitiesTitle": "What you can do",
  "solutions.detail.accessTitle": "Access and availability",
  "solutions.detail.audience": "Audience",
  "solutions.detail.markets": "Markets",
  "solutions.detail.languages": "Languages",
  "solutions.detail.access": "Access",
  "solutions.detail.publicAccess": "Public access",
  "solutions.detail.informationLabel": "Information: {status}",
  "solutions.detail.betaTitle": "Beta version",
  "solutions.detail.latestUpdate": "Latest update — {date}",
  "solutions.detail.releaseNotes": "Read the release notes",
  "solutions.lifecycle.draft.label": "Draft",
  "solutions.lifecycle.draft.description": "Visible in the console only.",
  "solutions.lifecycle.internal.label": "Internal",
  "solutions.lifecycle.internal.description": "Reserved for Shongre teams.",
  "solutions.lifecycle.comingSoon.label": "Coming soon",
  "solutions.lifecycle.comingSoon.description":
    "Publicly presented without launch access.",
  "solutions.lifecycle.beta.label": "Beta",
  "solutions.lifecycle.beta.description":
    "Available within an explicit release scope.",
  "solutions.lifecycle.available.label": "Available",
  "solutions.lifecycle.available.description": "The solution can be launched.",
  "solutions.lifecycle.maintenance.label": "Maintenance",
  "solutions.lifecycle.maintenance.description":
    "Visible but temporarily unavailable to launch.",
  "solutions.lifecycle.deprecated.label": "End of life",
  "solutions.lifecycle.deprecated.description":
    "Available with migration guidance.",
  "solutions.lifecycle.retired.label": "Retired",
  "solutions.lifecycle.retired.description":
    "Hidden from the public catalogue and retained in history.",
  "solutions.launch.retired": "Solution retired",
  "solutions.launch.restricted": "Restricted access",
  "solutions.launch.notify": "Notify me",
  "solutions.launch.comingSoonMessage": "This solution is coming soon.",
  "solutions.launch.maintenance": "Maintenance in progress",
  "solutions.launch.maintenanceMessage":
    "This solution is temporarily unavailable.",
  "solutions.launch.marketUnavailable": "Unavailable in this market",
  "solutions.launch.signIn": "Sign in to continue",
  "solutions.launch.activate": "Enable this solution",
  "solutions.launch.destinationUnavailable": "Destination unavailable",
  "solutions.launch.openProspects": "Open Prospects",
  "solutions.launch.openFacturation": "Explore Invoicing",
  "solutions.launch.openMarketplace": "Open the Marketplace",
  "solutions.launch.openSolution": "Open solution",
  "solutions.launch.deprecatedMessage":
    "A replacement solution is recommended.",
  ...
  "admin.solutions.transitionConfirmTitle": "Change to “{lifecycle}”?",
  "admin.solutions.created": "Created",
  "nav.categoryNavigation": "Category navigation",
  "nav.category.scrollPrevious": "Scroll categories left",
  "nav.category.scrollNext": "Scroll categories right",
  ...
  "shell.marketDetection.chooseAnother": "Choose another country",
  "shell.marketDetection.ignore": "Ignore",
  "shell.marketDetection.unknownTitle": "We could not estimate your country",
  "shell.marketDetection.failureTitle":
    "Country suggestion is temporarily unavailable",
  "shell.marketDetection.selectCountryBody":
    "Public browsing remains available. Choose your country or try again.",
  "shell.marketDetection.chooseCountry": "Choose my country",
  ...
  "shell.marketDetection.handoffFailed":
    "The secure session transfer did not complete. Try again without leaving this page.",
  ...
  "ui.sellerIdentity.openIndividual": "View {name}'s profile",
  ...
  "search.searchPage.loadError":
    "Listings could not be loaded right now. Your filters have been preserved.",
  ...
  "home.heroBoostedScroll.pause": "Pause carousel",
  "home.heroBoostedScroll.play": "Resume carousel",
  ...
  "listings.listingDetailPage.gererMesAnnoncesStats": "Manage my listings",
  ...
  "publishing.preparation.skipNextTime":
    "Do not show this preparation again on this device",
  ...
  "employment.search.recentlyViewed": "Recently viewed jobs",
  ...
  "admin.discovery.title": "Search and discovery",
  "admin.discovery.tab": "Discovery",
  "admin.discovery.description":
    "Subscriptions, advertising spend, and seller type are excluded from organic scoring. Paid visibility always remains a separate, labelled placement.",
  "admin.discovery.loading": "Loading the discovery policy…",
  "admin.discovery.unavailableTitle": "Discovery policy unavailable",
  "admin.discovery.unavailable": "The configuration could not be loaded.",
  "admin.discovery.saveError": "The configuration could not be saved.",
  "admin.discovery.reasonPrompt": "A reason is required (8 characters minimum)",
  "admin.discovery.publishReason": "Activate the discovery policy",
  "admin.discovery.draftReason": "Prepare the discovery policy",
  "admin.discovery.publishedNotice": "Policy {version} activated and audited.",
  "admin.discovery.draftNotice":
    "Draft {version} created without changing the active policy.",
  "admin.discovery.saveDraft": "Save draft",
  "admin.discovery.publish": "Publish",
  "admin.discovery.metricsTitle": "30-day observability",
  "admin.discovery.weightsTitle": "Organic weights",
  "admin.discovery.total": "Total {total}",
  "admin.discovery.sponsoredTitle": "Controlled sponsored insertion",
  "admin.discovery.positions": "Positions",
  "admin.discovery.maxPerPage": "Maximum per page",
  "admin.discovery.maxShare": "Maximum share",
  "admin.discovery.minimumRelevance": "Minimum relevance",
  "admin.discovery.weight.relevance": "Text relevance",
  "admin.discovery.weight.category": "Category",
  "admin.discovery.weight.location": "Location",
  "admin.discovery.weight.quality": "Quality",
  "admin.discovery.weight.freshness": "Genuine freshness",
  "admin.discovery.weight.trust": "Trust",
  "admin.discovery.weight.price": "Price plausibility",
  "admin.discovery.weight.personalization": "Personalization",
  "admin.discovery.metric.searches": "Searches",
  "admin.discovery.metric.noResults": "No results",
  "admin.discovery.metric.sponsored": "Sponsored placements",
  ...
  "monetization.marketRequired":
    "Select a country before accessing paid offers.",
  ...
  "digital.common.title": "Digital products",
  "digital.common.simulated": "Simulation — no real payment or access",
  "digital.common.noShipping": "No physical shipping",
  "digital.common.loading": "Loading digital access…",
  "digital.common.error": "Digital information is temporarily unavailable.",
  "digital.common.retry": "Retry",
  "digital.common.empty": "No digital purchase for this market.",
  "digital.purchases.title": "My digital purchases",
  "digital.purchases.description":
    "Downloads, links, credentials, and access being prepared are kept here.",
  "digital.purchases.download": "Download",
  "digital.purchases.open": "Open link",
  "digital.purchases.reveal": "Show my access",
  "digital.purchases.provisioning": "Access being prepared",
  "digital.purchases.copy": "Copy",
  "digital.purchases.copied": "Copied",
  "digital.purchases.mask": "Hide access details",
  "digital.purchases.leaveTitle": "You are leaving Shongre",
  "digital.purchases.leaveDescription":
    "Check the domain before continuing. Secret link parameters remain hidden.",
  "digital.purchases.continue": "Continue to service",
  "digital.purchases.cancel": "Cancel",
  "digital.purchases.report": "Report an access problem",
  "digital.purchases.reportDescription":
    "Describe the problem without entering a link, password, code, or other secret.",
  "digital.purchases.reportSubmit": "Send to support",
  "digital.purchases.reportSent":
    "The report was sent without including a secret.",
  "digital.purchases.unavailable": "Access unavailable",
  "digital.purchases.expired": "Access expired",
  "digital.purchases.revoked": "Access revoked",
  "digital.purchases.limitReached": "Access limit reached",
  "digital.purchases.paymentPending": "Payment confirmation pending",
  "digital.purchases.paymentFailed": "Payment failed or cancelled",
  "digital.purchases.processing": "Preparing access",
  "digital.purchases.disputed": "Access suspended during dispute",
  "digital.purchases.refunded": "Order refunded",
  "digital.purchases.available": "Access available",
  "digital.purchases.version": "Version {version}",
  "digital.fulfillment.heading": "Product fulfilment method",
  "digital.fulfillment.description":
    "Explicitly choose physical or digital fulfilment. The category never decides the fulfilment method.",
  "digital.fulfillment.physical": "Physical product",
  "digital.fulfillment.file": "Downloadable file",
  "digital.fulfillment.link": "Access link",
  "digital.fulfillment.credentials": "Link and credentials",
  "digital.fulfillment.provisioned": "Access created after payment",
  "digital.fulfillment.combined": "Combined link and credentials",
  "digital.fulfillment.profileRequired":
    "First accept the seller responsibilities for this market.",
  "digital.fulfillment.policyDisabled":
    "Digital sales remain disabled until required market decisions are approved.",
  "digital.fulfillment.productVersion": "Product version",
  "digital.fulfillment.receivedDescription": "What the buyer will receive",
  "digital.fulfillment.compatibility": "Compatibility, one per line",
  "digital.fulfillment.requirements": "Requirements, one per line",
  "digital.fulfillment.provisioningHours": "Fulfilment time in hours",
  "digital.fulfillment.privateFile": "Private paid file",
  "digital.fulfillment.upload": "Upload and check",
  "digital.fulfillment.uploading": "Uploading and checking…",
  "digital.fulfillment.linkLabel": "Secret access link",
  "digital.fulfillment.displayDomain": "Domain shown to buyer",
  "digital.fulfillment.accessClass": "Allowed access class",
  "digital.fulfillment.username": "Username",
  "digital.fulfillment.password": "Password, code, or key",
  "digital.fulfillment.protect": "Validate and protect access",
  "digital.fulfillment.protected": "Encrypted and masked access",
  "digital.fulfillment.uniqueInventory": "Unique keys, one per line",
  "digital.fulfillment.importInventory": "Encrypt and import inventory",
  "digital.fulfillment.inventoryReady": "{count} unique accesses available",
  "digital.fulfillment.ready":
    "Configuration ready for validation and moderation.",
  "digital.seller.title": "Sell digital products",
  "digital.seller.description":
    "Configure fulfilment methods and review requirements projected by market policy.",
  "digital.seller.save": "Accept responsibilities",
  "digital.seller.current": "Responsibilities current for version {version}",
  "digital.seller.requirements": "Applicable requirements",
  "digital.seller.noReacceptance":
    "Existing sellers are prompted again only when a new policy version requires it.",
  "digital.seller.invalidCombination":
    "This fulfilment-method combination is not allowed in this market.",
  "digital.seller.security":
    "Private files, links, credentials, and codes must never be placed in public listing text. Delivery and support remain subject to the controls shown below.",
  "digital.seller.files": "Allowed files",
  "digital.seller.verification": "Required verification",
  "digital.seller.provisioningDeadline": "Maximum fulfilment time",
  "digital.seller.accessLimits": "Default downloads / reveals",
  "digital.seller.tasks": "Access to prepare",
  "digital.seller.tasksDescription":
    "Only orders whose payment was confirmed by Shongre appear here. Submitted access data is protected and is never included in notifications.",
  "digital.seller.noTasks": "No digital access needs preparation.",
  "digital.seller.taskDeadline": "Due by {date}",
  "digital.seller.destinationUrl": "HTTPS access link",
  "digital.seller.username": "Optional username",
  "digital.seller.accessSecret": "Password, code, or key",
  "digital.seller.completeTask": "Protect and deliver access",
  "digital.admin.title": "Digital product operations",
  "digital.admin.description":
    "File, inventory, access, and report states without exposing secrets or storage keys.",
  "digital.admin.assets": "Private files",
  "digital.admin.inventory": "Access inventories",
  "digital.admin.reports": "Open reports",
  "digital.admin.entitlements": "Entitlements",
  "digital.admin.approve": "Approve",
  "digital.admin.reject": "Reject",
  "digital.admin.policy": "Market policy",
  "digital.admin.policyDescription":
    "Changes create a new disabled version. Activation requires tax, legal, refund, withdrawal, and payment evidence.",
  "digital.admin.categories": "Allowed category identifiers, comma-separated",
  "digital.admin.domains": "Approved external domains, comma-separated",
  "digital.admin.mimeTypes": "Allowed MIME types",
  "digital.admin.extensions": "Allowed extensions",
  "digital.admin.accessClasses": "Allowed access classes",
  "digital.admin.prohibitedClasses": "Prohibited access classes",
  "digital.admin.taxEvidence": "Approved tax policy version",
  "digital.admin.refundEvidence": "Approved refund policy version",
  "digital.admin.withdrawalEvidence":
    "Approved withdrawal presentation version",
  "digital.admin.paymentEvidence": "Approved payment configuration",
  "digital.admin.legalEvidence": "Legal approval evidence",
  "digital.admin.fulfillmentTypes": "Allowed fulfilment methods",
  "digital.admin.capabilities": "Activatable capabilities",
  "digital.admin.changeReason": "Auditable reason for the change",
  "digital.admin.createDraft": "Create disabled version",
  "digital.admin.activate": "Activate this version",
  "digital.admin.failClosed":
    "An incomplete or unevidenced version remains disabled. Activation requires affected sellers to accept the new version.",
  "digital.asset.processing": "Processing",
  "digital.asset.ready": "Ready",
  "digital.asset.quarantined": "Quarantined",
  "digital.asset.rejected": "Rejected",
  "digital.asset.unavailable": "Unavailable",
  "digital.checkout.processing":
    "Payment provider return received. Server confirmation is still pending; no access has been granted yet.",
  "digital.checkout.cancelled":
    "Payment was cancelled. No digital access was granted.",
  "digital.checkout.refresh": "Refresh status",
  "digital.nav.purchases": "Digital purchases",
  "digital.nav.seller": "Digital selling",
  "digital.nav.admin": "Digital products",
  "meta.digitalPurchases.title": "My digital purchases",
  "meta.digitalPurchases.description":
    "Authenticated access to Shongre digital purchases.",
  "meta.digitalSeller.title": "Sell digital products",
  "meta.digitalSeller.description":
    "Seller responsibilities and digital fulfilment methods.",
  "meta.digitalAdmin.title": "Digital product administration",
  "meta.digitalAdmin.description":
    "Private operational view of Shongre digital products.",
  ...
  "admin.adminOverviewPage.reviewReports": "Review reports",
  "admin.adminOverviewPage.reviewProfessionals": "Verify professionals",
