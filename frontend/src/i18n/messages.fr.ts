...
export const messagesFr = {
  ...
  'collections.collectionsPage.annoncesDeLaCollection': "Annonces de la collection",
  ...
  'home.homeRecentSearches.supprimerCetteRecherche': "Supprimer cette recherche",
  ...
  'home.homeCollectionsSection.amenagezVotreExterieur': "Aménagez votre extérieur",
  ...
  'meta.favorites.description': 'Retrouvez les annonces que vous avez mises de côté sur Shongre.',
  'meta.savedSearches.title': 'Mes recherches sauvegardées',
  'meta.savedSearches.description': 'Gérez vos recherches enregistrées et vos alertes Shongre.',
  'meta.messaging.title': 'Messagerie',
  'meta.messaging.description': 'Vos échanges avec les acheteurs et les vendeurs, offres et suivi de commande.',
  'meta.notifications.title': 'Centre de notifications',
  'meta.notifications.description': 'Alertes de recherche, baisses de prix et suivi de vos offres.',
  'meta.notificationPreferences.title': 'Préférences de notifications',
  'meta.notificationPreferences.description': 'Choisissez les alertes que vous recevez sur chaque canal.',
  'meta.transactions.title': 'Transactions, réservations & séquestre',
  'meta.transactions.description': 'Suivez vos achats, vos ventes et la libération des fonds.',
  'meta.verificationCenter.title': 'Sécurité & vérification du compte',
  'meta.verificationCenter.description': 'Email, téléphone, identité, entreprise et coordonnées bancaires.',
  'meta.supportRequests.title': 'Aide & assistance',
  'meta.supportRequests.description': 'Vos demandes de support Shongre et leur avancement.',
  'meta.supportRequestDetail.title': 'Détail de la demande de support',
  'meta.supportRequestDetail.description': 'Suivi de votre échange avec le support Shongre.',
  'meta.accountOverview.title': 'Mon compte',
  'meta.accountOverview.description': 'Vue d\'ensemble de votre compte, vérifications et coordonnées.',
  'meta.myListings.title': 'Gestion de mes annonces',
  'meta.myListings.description': 'Suivez les vues, activez des boosts de visibilité et gérez vos stocks.',
  'meta.proDashboard.title': 'Tableau de bord vendeur Pro',
  'meta.proDashboard.description': 'Performances de votre catalogue commercial et conversion clients.',
  'meta.proStorefrontEditor.title': 'Personnaliser ma vitrine professionnelle',
  'meta.proStorefrontEditor.description': 'Bannière, présentation et mise en avant de votre boutique Pro.',
  'meta.publishWizard.title': 'Déposer une annonce',
  'meta.publishWizard.description': 'Publiez une annonce sur Shongre en trois étapes : catégorie, description et remise.',
  'meta.newsletterPreferences.title': 'Préférences newsletter',
  'meta.newsletterPreferences.description': 'Gérez vos abonnements aux sélections et bons plans Shongre.',
  'meta.newsletterConfirm.title': 'Confirmation d\'abonnement',
  'meta.newsletterConfirm.description': 'Confirmez votre inscription à la newsletter Shongre.',
  'meta.newsletterUnsubscribe.title': 'Désabonnement newsletter',
  'meta.newsletterUnsubscribe.description': 'Gérez ou arrêtez votre abonnement à la newsletter Shongre.',
  'meta.adminOverview.title': 'Console d\'administration',
  'meta.adminOverview.description': 'Vue d\'ensemble de la gouvernance plateforme.',
  'meta.adminModeration.title': 'Modération & signalements',
  'meta.adminModeration.description': 'File de modération des annonces et des signalements.',
  'meta.adminUsers.title': 'Annuaire des utilisateurs & vérifications',
  'meta.adminUsers.description': 'Administration des comptes particuliers, professionnels et internes.',
  'meta.adminVerifications.title': 'Pôle de vérification & sécurité',
  'meta.adminVerifications.description': 'Dossiers KYC, KYB et coordonnées bancaires en attente.',
  'meta.adminMarkets.title': 'Gestion multi-marchés & territoires',
  'meta.adminMarkets.description': 'Configuration des marchés, devises et locales.',
  'meta.adminTaxonomy.title': 'Administration de la taxonomie',
  'meta.adminTaxonomy.description': 'Catégories, sous-catégories et attributs de la place de marché.',
  'meta.adminMonetization.title': 'Formules Pro, quotas & mise en avant',
  'meta.adminMonetization.description': 'Configuration des forfaits professionnels et des options payantes.',
  'meta.adminRolesMatrix.title': 'Matrice des rôles & permissions',
  'meta.adminRolesMatrix.description': 'Référentiel des rôles plateforme et de leurs permissions.',
  'meta.adminAuditLogs.title': 'Registre d\'audit sécurité',
  'meta.adminAuditLogs.description': 'Journal des actions sensibles réalisées sur la plateforme.',
  'meta.adminNewsletter.title': 'Campagnes & newsletters',
  'meta.adminNewsletter.description': 'Historique et préparation des campagnes marketing.',
  'meta.adminProviders.title': 'Fournisseurs & intégrations externes',
  'meta.adminProviders.description': 'Catalogue des intégrations, routage et secours.',
  'meta.adminProviderDetail.title': 'Configuration d\'un fournisseur',
  'meta.adminProviderDetail.description': 'Clés d\'accès, marchés, santé et journal d\'audit du fournisseur.',
  'meta.crmOverview.title': 'Tableau de bord CRM & pipeline',
  'meta.crmOverview.description': 'Prospects, opportunités et tâches commerciales.',
  'meta.crmContacts.title': 'Contacts & interlocuteurs',
  'meta.crmContacts.description': 'Répertoire des contacts commerciaux Shongre.',
  'meta.crmContactDetail.title': 'Fiche contact',
  'meta.crmContactDetail.description': 'Historique et opportunités liés à ce contact.',
  'meta.crmCompanies.title': 'Entreprises & vendeurs B2B',
  'meta.crmCompanies.description': 'Répertoire des entreprises suivies par le commerce.',
  'meta.crmCompanyDetail.title': 'Fiche entreprise',
  'meta.crmCompanyDetail.description': 'Contacts, opportunités et activité de cette entreprise.',
  'meta.crmPipeline.title': 'Pipeline des ventes & forfaits Pro',
  'meta.crmPipeline.description': 'Suivi des négociations et des abonnements professionnels.',
  'meta.crmAiProspecting.title': 'Prospection assistée par IA',
  'meta.crmAiProspecting.description': 'Recherche de futurs vendeurs professionnels qualifiés.',
  ...
  'admin.taxonomyHierarchyTree.ajouterSousRubriqueNode': 'Ajouter une sous-rubrique à {name}',
  'admin.crmPipelinePage.etapePrecedenteOpp': 'Déplacer « {name} » à l\'étape précédente',
  'admin.crmPipelinePage.etapeSuivanteOpp': 'Déplacer « {name} » à l\'étape suivante',
  'admin.adminAuditLogsPage.voirLePayloadDe': 'Voir le payload complet de « {action} »',
  ...
  'publishing.publishWizard.rechercherUneCategorie': 'Rechercher une catégorie ou un type de bien',
  'admin.taxonomyNodeEditor.copierLIdStable': 'Copier l\'identifiant stable {id}',
  ...
  'admin.adminUsersPage.utilisateursTrouves_other': '{count} utilisateurs trouvés',
  ...
  'notifications.notificationPreferencesPage.canalPourAlerte': '{channel} — {alert}',
  'notifications.notificationPreferencesPage.canalApplication': "Sur l'application",
  ...
  'shell.demoRoleSwitcher.roleHorsPersonasDemo': 'Rôle plateforme hors des personas de démonstration',
  'sellerworkspace.proDashboardPage.pasEncoreDeDonnees': 'Pas encore de données',
  'sellerworkspace.proDashboardPage.totalVuesUniques': 'Total : {count} vues uniques',
