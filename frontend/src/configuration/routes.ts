...
export const routes = {
  ...
  search: (queryOrParams?: string | SearchRouteParams, view?: string) => {
    ...
    if (typeof queryOrParams === 'string') {
      ...
      if (queryOrParams.subCategory) params.set('subCategory', queryOrParams.subCategory);
      if (queryOrParams.city) params.set('city', queryOrParams.city);
      if (queryOrParams.radius && queryOrParams.radius !== '0' && queryOrParams.radius !== 0) {
        params.set('radius', String(queryOrParams.radius));
      }
      if (queryOrParams.view || view) params.set('view', (queryOrParams.view || view)!);
