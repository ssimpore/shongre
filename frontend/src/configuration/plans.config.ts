...
export const LISTING_BOOSTS: ListingBoostOption[] = [
  {
    id: 'urgent',
    name: 'Badge Urgent',
    description: 'Affiche un macaron "Urgent" attirant immédiatement l\'attention dans les résultats.',
    durationDays: 7,
    priceEur: 3.50,
    badgeLabel: 'Urgent',
  ...
  },
  {
    ...
    description: 'Remonte votre annonce tout en haut des résultats de recherche chaque jour pendant 7 jours.',
    durationDays: 7,
    priceEur: 6.90,
    badgeLabel: 'À la une',
  ...
  },
  {
    ...
    description: 'Bordure terracotta distinctive et fond contrasté pour émerger des autres annonces.',
    durationDays: 14,
    priceEur: 8.50,
  ...
  },
  {
    ...
    description: 'Encart grand format sur la page d\'accueil + remontée quotidienne + badge urgent.',
    durationDays: 14,
    priceEur: 14.90,
