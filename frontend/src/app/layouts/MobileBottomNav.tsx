...
export const MobileBottomNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-header border-t border-border-base bg-bg-surface/95 pb-safe-area-bottom shadow-sticky backdrop-blur-xl md:hidden"
    >
