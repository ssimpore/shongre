    ...
    >
      ...
      <div className="grid grid-cols-5 h-[var(--mobile-nav-h)] items-center px-1">
        ...
        >
          {({ isActive }) => (
            <>
              <div className={`flex items-center justify-center w-12 h-7 rounded-pill motion-interactive ${isActive ? 'bg-bg-muted' : 'bg-transparent'}`}>
        ...
        >
          {({ isActive }) => (
            <>
              <div className={`relative flex items-center justify-center w-12 h-7 rounded-pill motion-interactive ${isActive ? 'bg-bg-muted' : 'bg-transparent'}`}>
