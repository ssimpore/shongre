...
const INITIAL_AUDIT_LOGS: SecurityAuditLog[] = [
  {
    ...
    details: 'Vérification SIRET et Kbis validée avec succès (Document RCS Bordeaux n° 849204892). Attribution du badge Pro Vérifié.',
  ...
  },
  {
    ...
    details: 'Suspension préventive du compte suite à 4 signalements concordants pour tentative de paiement hors plateforme sécurisée.',
  ...
  },
  {
    ...
    details: 'Attribution du rôle Market Manager avec portée territoriale limitée au marché Belgique (BE).',
  ...
  },
  {
    ...
    details: 'Masquage immédiat de l\'annonce list-fake-99 pour suspicion de contrefaçon / escroquerie.',
    previousValue: { status: 'active' },
...
class AuditService {
  ...
  exportLogsAsCsv(): string {
    ...
    const headers = ['ID', 'Date', 'Auteur (ID)', 'Auteur (Nom)', 'Rôle', 'Cible (ID)', 'Cible (Nom)', 'Action', 'Détails', 'Marché', 'IP'];
  ...
  logEvent(entry: Omit<SecurityAuditLog, 'id' | 'timestamp'>): SecurityAuditLog {
