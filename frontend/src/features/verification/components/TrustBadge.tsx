      ...
      case "identity":
        return (
          ...
          >
            ...
            {showLabel && (
              <span>{t("verification.trustBadge.identiteVerifiee")}</span>
            )}
          </span>
        );
      case "business":
        return (
          ...
          >
            ...
            {showLabel && (
              <span>{t("verification.trustBadge.proCertifieRcs")}</span>
            )}
          </span>
        );
      case "phone":
        return (
          ...
          >
            ...
            {showLabel && (
              <span>{t("verification.trustBadge.telephoneCertifie")}</span>
            )}
          </span>
        );
      case "bank_payout":
        return (
          ...
          >
            ...
            {showLabel && (
              <span>{t("verification.trustBadge.ibanVerifie")}</span>
            )}
          </span>
        );
      case "mfa":
    ...
    case "tier_4_verified_pro":
      return (
        ...
        >
          <Building2 className={iconSizes[size]} />
          {showLabel && (
            <span>{t("verification.trustBadge.boutiqueProVerifiee")}</span>
          )}
        </span>
      );
    case "tier_3_trusted_seller":
      return (
        ...
        >
          ...
          {showLabel && (
            <span>{t("verification.trustBadge.vendeurDeConfiance")}</span>
          )}
        </span>
      );
    case "tier_2_verified_member":
      return (
        ...
        >
          <CheckCircle2 className={iconSizes[size]} />
          {showLabel && (
            <span>{t("verification.trustBadge.membreVerifie")}</span>
          )}
        </span>
      );
    case "tier_1_starter":
      return (
        ...
        >
          <ShieldCheck className={iconSizes[size]} />
          {showLabel && (
            <span>{t("verification.trustBadge.compteDebutant")}</span>
          )}
        </span>
      );
    default:
