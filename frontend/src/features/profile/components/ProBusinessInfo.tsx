      ...
      <div className="bg-white rounded-2xl border border-border-base p-5 sm:p-7 shadow-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
          <div className="bg-bg-base p-3 rounded-xl border border-border-base">
            <span className="text-stone-500 font-medium block text-xs">Raison sociale</span>
          ...
          <div className="bg-bg-base p-3 rounded-xl border border-border-base">
            <span className="text-stone-500 font-medium block text-xs">Forme juridique</span>
            <span className="font-bold text-stone-900 text-xs sm:text-sm">
          ...
          {seller.vatNumber && (
            <div className="bg-bg-base p-3 rounded-xl border border-border-base">
              <span className="text-stone-500 font-medium block text-xs">N° TVA Intracommunautaire</span>
              <span className="font-bold font-mono text-stone-900 text-xs sm:text-sm">
                {seller.vatNumber}
              </span>
            </div>
          ...
          {seller.websiteUrl && (
            <div className="bg-bg-base p-3 rounded-xl border border-border-base">
              <span className="text-stone-500 font-medium block text-xs">Site internet officiel</span>
              <a
