      ...
      <div className="p-4 border-b border-border-base space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-8 text-xs font-semibold bg-stone-50 border border-border-base rounded-xl focus:bg-white focus:border-primary focus:outline-none transition-all placeholder:text-stone-400"
          />
          {searchQuery && (
            <button
              type="button"
