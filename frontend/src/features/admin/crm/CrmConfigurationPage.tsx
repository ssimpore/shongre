...
const entries = [
  {
    to: "/admin/crm/configuration/pipelines",
    title: "Pipelines & étapes",
    description: "Cycles de vente, probabilités et règles de clôture.",
    icon: GitBranch,
  },
  {
    to: "/admin/crm/configuration/champs",
    title: "Champs personnalisés",
    description: "Modèle de données extensible par entité.",
    icon: Braces,
  },
  {
    to: "/admin/crm/produits",
    title: "Produits & tarifs",
    description: "Catalogue commercial et grilles de prix par marché.",
    icon: Boxes,
  },
  {
    to: "/admin/crm/configuration/providers",
    title: "Connexions fournisseurs",
    description: "Messagerie, email, calendrier, SMS et téléphonie.",
    icon: Cable,
  },
  {
    to: "/admin/crm/configuration/ai",
    title: "IA & modèles",
    description: "BYOK, routage de modèles, permissions et usage.",
    icon: Bot,
  },
  {
    to: "/admin/crm/automations",
    title: "Automatisations",
    description: "Workflows et séquences commerciales sécurisés.",
    icon: Workflow,
  },
  {
    to: "/admin/crm/rapports",
    title: "Rapports",
    description: "Prévision, performance et exécution commerciale.",
