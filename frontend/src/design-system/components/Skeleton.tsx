...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  <div
    ...
    className={cn('animate-pulse bg-stone-200/80', shape && shapeClasses[shape], className)}
    {...props}
  />
);

export const ListingCardSkeleton: React.FC<{ className?: string }> = ({ className }) => (
...
export const TableSkeleton: React.FC<{ rows?: number; className?: string }> = ({
  ...
  <div aria-hidden="true" className={cn('divide-y divide-border-subtle', className)}>
