...
import { listingDisplayResolver } from '../../domains/listing/listing.display.js';
import { taxonomyService } from '../../domains/taxonomy/taxonomy.service.js';
...
const mockListing: Listing = {
  ...
  marketCode: 'FR',
  photos: [{ id: 'p1', url: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400', isCover: true }],
  coverImageUrl: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400',
  status: 'active',
...
describe('Listing Display & Card Data Presentation', () => {
  it('resolves summary attributes accurately for listing cards', () => {
    ...
    const attrs = listingDisplayResolver.resolveSummaryAttributes(mockListing, node);
  ...
  it('generates accurate SEO metadata and title for listing detail', () => {
    ...
    const seo = listingDisplayResolver.generateListingSeoMeta(mockListing, node);
